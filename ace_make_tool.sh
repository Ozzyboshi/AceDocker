...
${PROJECTNAME}_LDADD = ammxasm.o
${PROJECTNAME}_SOURCES = main.c $PROJECTNAME.c

ammxasm.o: ammxasm.s
	vasmm68k_mot -devpac -Fhunk -quiet -esc  -m68080 ./ammxasm.s  -o ./ammxasm.o -I/usr/local/amiga/os-include
" >> ${SRCDIR}/Makefile.am

echo "File ${SRCDIR}/Makefile.am created"

echo "	XDEF _ammxmainloop
